...
namespace libEDSsharp
{
    ...
    public class ODentry
    {
        ...
        [EdsExport]
        public string parameter_name_trans = "";
        ...
        public void Write(StreamWriter writer, InfoSection.Filetype ft, Odtype odt= Odtype.NORMAL, int module=0)
        {
            ...
            writer.WriteLine(string.Format("ParameterNameTrans={0}", parameter_name_trans));
    ...
    public class EDSsharp
    {
        ...
        public void ParseEDSentry(KeyValuePair<string, Dictionary<string, string>> kvp)
        {
            ...
            if (m.Success)
            {
                ...
                try
                {
                    if (!kvp.Value.ContainsKey("ParameterNameTrans"))
                        throw new ParameterException("Missing required field ParameterNameTrans on" + section);
                    od.parameter_name_trans = kvp.Value["ParameterNameTrans"];
                }
                catch
                { }

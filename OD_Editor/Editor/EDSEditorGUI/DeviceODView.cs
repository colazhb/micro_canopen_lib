...
namespace ODEditor
{
    ...
    public partial class DeviceODView : MyTabUserControl
    {
        ...
        public void PopulateObject()
        {
            ...
            textBox_name_trans.Text = od.parameter_name_trans;
        ...
        private void Button_saveChanges_Click(object sender, EventArgs e)
        {
            ...
            od.parameter_name_trans = textBox_name_trans.Text;
        ...
        private static string Producer(string txt)
        {
            Translation tr = new Translation();
            var result = tr.TransAsync(txt);
            return "";

        }
        private async void textBox_name_trans_DoubleClick(object sender, EventArgs e)
        {
            TextBox tx = (TextBox)sender;
            Translation tr = new Translation();
            string ss = await tr.TransAsync(textBox_name.Text);
            tx.Text = ss;
